...
struct saveFileItems
{
	int ether_index;
};

struct saveFileInventory
{
	int template_idx;
	int inv_itemcount;
	std::vector<saveFileItems> items;
};

struct saveFileHeaders
{
	//lol
	int startTime;
	int viewercursor_x;
	...
	int gamemode;
	int inv_cellcount;
	std::vector<saveFileInventory> inventoryCells;
};
